  ...
  return (
    <div className="bg-white">
      ...
      <main>
        ...
        {/* Featured section */}
        <section aria-labelledby="comfort-heading" className="px-4 py-24 mx-auto max-w-7xl sm:px-6 sm:py-32 lg:px-8">
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              <img
    ...
    <footer className="bg-gray-900" aria-labelledby="footer-heading">
      ...
      <div className="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div>
  <h3 className="text-sm font-semibold leading-6 text-center text-white lg:text-left">Subscribe to our newsletter</h3>
  <p className="mt-2 text-sm leading-6 text-center text-gray-300 lg:text-left">
