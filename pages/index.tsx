...
export default function Example() {
  ...
  <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-12">
    <div className="bg-gray-900 sm:py-24 lg:py-16 mt-16">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
        <div className="max-w-xl text-3xl font-medium tracking-tight text-white sm:text-4xl lg:col-span-7 mt-0">
        ...
        <form className="w-full max-w-md lg:col-span-5 lg:pt-2">
          ...
          <p className="mt-4 text-sm leading-6 text-gray-300 hidden sm:block">
